using ClientSideEvaluationApp.Models;
using Microsoft.EntityFrameworkCore;

#pragma warning disable CS8618

namespace ClientSideEvaluationApp.Data;
...
public class StoreContext : DbContext
{
    ...
    //protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlite("Data Source=orders.db");
